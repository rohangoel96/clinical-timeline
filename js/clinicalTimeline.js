...
var clinicalTimeline = (function(){
  ...
  function daysToTimeObject(dayCount) {
      var time = {};
      var daysPerYear = util.timelineConstants.DAYS_PER_YEAR;
      var daysPerMonth = util.timelineConstants.DAYS_PER_MONTH;
  ...
  function formatTime(time, zoomLevel) {
      ...
      if (util.timelineConstants.ALLOWED_ZOOM_LEVELS.indexOf(zoomLevel) > -1){
